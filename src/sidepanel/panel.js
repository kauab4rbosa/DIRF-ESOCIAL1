...
(function () {
  ...
  // O upload da pasta e a geração rodam na página dedicada (aba normal),
  // que lida melhor com seleção de pastas e arquivos grandes.
  const btnAbrirGerador = $('abrirGerador');
  if (btnAbrirGerador) {
    btnAbrirGerador.addEventListener('click', () => {
